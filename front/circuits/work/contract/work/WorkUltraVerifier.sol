// Verification Key Hash: f9d2a2d925fa56f3c35696eb77a9bdff164013886c19e4f771a6ee349c812ce8
// SPDX-License-Identifier: Apache-2.0
// Copyright 2022 Aztec
pragma solidity >=0.8.4;

library WorkUltraVerificationKey {
    function verificationKeyHash() internal pure returns (bytes32) {
        return
            0xf9d2a2d925fa56f3c35696eb77a9bdff164013886c19e4f771a6ee349c812ce8;
    }
    ...
    function loadVerificationKey(
        ...
        assembly {
            ...
            mstore(
                add(_vk, 0x80),
                0x245a0eb67369f8bc02360c4379606511e9a3cff43e23ea3b7c3964897f1624cd
            ) // vk.Q1.x
            mstore(
                add(_vk, 0xa0),
                0x18b1eb630b7e786f3d7114cad1997d8c00fc05793e26a7bef2f5511840c687c7
            ) // vk.Q1.y
            mstore(
                add(_vk, 0xc0),
                0x2d3d9319364ff5ccb46892a33757835483316a97aa847571558df31b8dc4a004
            ) // vk.Q2.x
            mstore(
                add(_vk, 0xe0),
                0x2c2ec2bb889088e3d8e302be3663f72a9ca9fc44c04ff8ec33f9db2bb4d9630c
            ) // vk.Q2.y
            mstore(
                add(_vk, 0x100),
                0x09d449d420db670e099d1c9c2df8165983973cd786f2adcd6e7614569c0df54b
            ) // vk.Q3.x
            mstore(
                add(_vk, 0x120),
                0x1e182a095c24d47dc7bc5661ee87c8af7fb184bb7d6921ef0b90995ca4e4f15e
            ) // vk.Q3.y
            mstore(
                add(_vk, 0x140),
                0x280d1cadaa9d1a1f7fdbe165185f36f626e464515c7e1bc8997c25418e728ed7
            ) // vk.Q4.x
            mstore(
                add(_vk, 0x160),
                0x2c7118454d635b761377acb9e3a99785caec17fb3c803fd68071bca973721963
            ) // vk.Q4.y
            mstore(
                add(_vk, 0x180),
                0x2d3036f503fc20d6478057ca81142e6a144f6bf69714f4e145791a3b970bb8de
            ) // vk.Q_M.x
            mstore(
                add(_vk, 0x1a0),
                0x13be4c046b933e9cba3a903bb55eea828d2a4e8c46f31e8b772463cd76e231b4
            ) // vk.Q_M.y
            mstore(
                add(_vk, 0x1c0),
                0x30465139f39f6ed67dc418a787e166546f5587f2ba6420065267c3d8321d56a2
            ) // vk.Q_C.x
            mstore(
                add(_vk, 0x1e0),
                0x2190f10f1b821e316f3c75037491a91a0e64ad0ffc088ee2be29fd13d371e63d
            ) // vk.Q_C.y
            mstore(
                add(_vk, 0x200),
                0x111a8565547a0edb09a09d2d088bbf20c438dee04fd8b432120b0c0b657550ad
            ) // vk.Q_ARITHMETIC.x
            mstore(
                add(_vk, 0x220),
                0x297bbfb48783e30ba099b710f592abfca804e57a4c451653c517f4f47b1eca54
            ) // vk.Q_ARITHMETIC.y
            mstore(
                add(_vk, 0x240),
                0x13ab6467b304d5eb5e60f60f1b55a088119182ad7ff7ba344c954fc3a4668ab7
            ) // vk.QSORT.x
            mstore(
                add(_vk, 0x260),
                0x0d88dd7c8429d49c4632398f25db0cbab521fafddb26b788298fcfb400e3039c
            ) // vk.QSORT.y
            mstore(
                add(_vk, 0x280),
            ...
            mstore(
                add(_vk, 0x300),
                0x0bf371fe255f0d278140879bad6169f98647ba0eed428d10a51478b8e451e0ef
            ) // vk.SIGMA1.x
            mstore(
                add(_vk, 0x320),
                0x0be31eaadabc20401143e3a685ec7253c128af42ae0d195b27fd6612012b1e64
            ) // vk.SIGMA1.y
            mstore(
                add(_vk, 0x340),
                0x1cf0294b1560bff126ee6539895ac2bd048ed0fb217d137567774771c62f4e5b
            ) // vk.SIGMA2.x
            mstore(
                add(_vk, 0x360),
                0x1390aafd2f33b29d55a2d257a7dc01fc8e222abc1af350f58195c1697fc417c3
            ) // vk.SIGMA2.y
            mstore(
                add(_vk, 0x380),
                0x1610d81e1af44e7f94f4aaadeafc93f08567c9812598c43d5937b46780663229
            ) // vk.SIGMA3.x
            mstore(
                add(_vk, 0x3a0),
                0x1c50ccc4f8b4af76049f02f89ad3fa92423a470ec8a340de23d6c29ada19adc3
            ) // vk.SIGMA3.y
            mstore(
                add(_vk, 0x3c0),
                0x00df72897e767abf1dfe1ca523ffa87a70e12588838ad7442cf8453fff529bc1
            ) // vk.SIGMA4.x
            mstore(
                add(_vk, 0x3e0),
                0x03bc3b046b21017db2f7cf2e1cff3dae82894f6c793e1e11a9611dc394d2807a
            ) // vk.SIGMA4.y
            mstore(
                add(_vk, 0x400),
            ...
            mstore(
                add(_vk, 0x540),
                0x004f3dbe24ac45d83cdb06d89a7ead2a5898b9d45fc46adf274f261e1d9a69f1
            ) // vk.ID1.x
            mstore(
                add(_vk, 0x560),
                0x1ad0d38396160883b4b36ba3f4b9ed31e22d7d9003ec26c869111db727ac86a2
            ) // vk.ID1.y
            mstore(
                add(_vk, 0x580),
                0x233d15ebb0c1bec2d16dc2b93bff51d0378c8b8f1c19f6492642a2ec9eb31778
            ) // vk.ID2.x
            mstore(
                add(_vk, 0x5a0),
                0x025bb45a50cdc6e449857dfb10fd81252906dc1a1a9d9ac8bd2693639c4d9098
            ) // vk.ID2.y
            mstore(
                add(_vk, 0x5c0),
                0x2ef93f5f71360c0663e0f8cbee40de3ae8c54be7aec789a301973e1f9c582326
            ) // vk.ID3.x
            mstore(
                add(_vk, 0x5e0),
                0x03446a36e56d1406db6e9d7105ba6598bbf8c1d3ee13de7c693587eeb27ca1a5
            ) // vk.ID3.y
            mstore(
                add(_vk, 0x600),
                0x049b5b9bad97b2824f3b5c6c8a2db4bfd95e8ff682c51b27d668fe681eb72d0b
            ) // vk.ID4.x
            mstore(
                add(_vk, 0x620),
                0x211f7e1a9cdb6bd4c2435d9a586eeea2d1d8a3faceb617081bceb326ae4fc99a
            ) // vk.ID4.y
 ...
 */
abstract contract WorkerBaseUltraVerifier {
...
contract WorkUltraVerifier is WorkerBaseUltraVerifier {
    function getVerificationKeyHash()
        public
        pure
        override(WorkerBaseUltraVerifier)
        returns (bytes32)
    {
        return WorkUltraVerificationKey.verificationKeyHash();
    }

    function loadVerificationKey(
        uint256 vk,
        uint256 _omegaInverseLoc
    ) internal pure virtual override(WorkerBaseUltraVerifier) {
        WorkUltraVerificationKey.loadVerificationKey(vk, _omegaInverseLoc);
    }
}
