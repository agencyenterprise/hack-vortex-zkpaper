...
function Component() {
  const [input, setInput] = useState<{ num_writes: string; num_pastes: string } | undefined>();
  ...
  return (
    <main>
      ...
      <form className="container" onSubmit={submit}>
        ...
        <p>Try it!</p>
        <input name="x" type="text" className="border-black border" />
        <input name="y" type="text" className="border-black border" />
        <button type="submit" className="bg-blue-500">Calculate proof</button>
      </form>
    </main>
  );
}
